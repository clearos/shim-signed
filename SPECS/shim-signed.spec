...
# ClearFoundation - still waiting for 32-bit release from upstream
#	exit 1
fi
...
%changelog
* Tue Sep 26 2017 ClearFoundation <developer@clearfoundation.com> - 12-1.clear
- Updated EFI for ClearOS
